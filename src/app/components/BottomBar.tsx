    ...
    return (
        <>
            <div className="fixed bottom-0 flex flex-wrap md:justify-content-center justify-content-evenly align-items-center w-full mx-0 h-4rem mt-4" style={{backgroundColor: "#060153"}}>
                <a href={disabled === 1 ? "#" : "/maps"} className={className} style={{textDecoration: "none", width: "20%", background: (disabled === 1 ? "#2B22BB99" : "")  }}><i className="pi pi-map font-light" style={{ fontSize: '2rem' }}></i></a>
