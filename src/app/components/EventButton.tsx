...
export default function EventButton({index = 0, title = "Lorem Ipsum", startTime = "7:40", endTime = "8:40", location = '' , anchor = "#" }) {
    let i = index;
    ...
    return (
        <div className="lg:col-5 md:col-6 md:m-0 max-w-28rem w-full grid justify-content-center bg-white p-2 mx-3 mb-3 border-round-xl">
            ...
            <div className="w-full flex gap-2 mx-2 mb-2">
                ...
                {Object.keys(location).length === 1 ? (<div className="flex-none p-2" style={colorStyle(sorter(i))}>
